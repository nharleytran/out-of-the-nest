...
describe('Extracurriculars component', () => {
    test('renders the input field correctly', () => {
        ...
        const { getByLabelText } = render(<Extracurriculars postData={{}} setPostdata={setPostdata}/>);
    ...
    test('should update extracurriculars value when input is changed', () => {
        ...
        const { getByLabelText } = render(
          <Extracurriculars postData={{ extracurriculars: '' }} setPostdata={setPostdata} />
        );
        const input = getByLabelText('Extracurriculars *');
    
        fireEvent.change(input, { target: { value: 'Lorem ipsum dolor sit amet' } });
    
        expect(setPostdata).toHaveBeenCalledWith({ extracurriculars: 'Lorem ipsum dolor sit amet' });
      });
});
