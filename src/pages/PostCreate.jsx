...
import CheckInfo from '../components/PostContent/CheckInfo'
import Description from '../components/PostContent/Description'
    ...
    <>
      <div className="postCreate">
        ...
        <Container>
          ...
          <CheckInfo postData={postData} setPostdata={setPostdata} />
          <div className="mantine-InputWrapper-root mantine-Textarea-root mantine-1ejqehl">
            <label className="mantine-InputWrapper-label mantine-Textarea-label mantine-1fzet7j">
              Description
              <span
                className="mantine-103svbs mantine-InputWrapper-required mantine-Textarea-required"
                aria-hidden="true">
                {' '}
                *
              </span>
            </label>
            <Description postData={postData} setPostdata={setPostdata} />
          </div>
        </Container>
